                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <tr style="text-align: center;" v-for="(employee ,index) in employee_form.data" :key="index">
                                            <td>{{ employee.school_code }}</td>
                    ...
                    <form @submit.prevent="addEmployee">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Enter employee number" v-model="employee_form.school_code" :class="errors.school_code ? 'is-invalid' : ''"> 
                                <div class="invalid-feedback" v-if="errors.school_code">{{errors.school_code[0]}}</div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="invalid-feedback" v-if="errors.school_code">{{errors.department[0]}}</div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" placeholder="Enter job title" v-model="employee_form.title" :class="errors.department ? 'is-invalid' : ''">
    ...
    methods: {
        ...
        addEmployee: async function(){
            try { 
                ...
                formData.append("school_code", this.employee_form.school_code);
                ...
                formData.append("birthdaty", this.employee_form.birthdaty);
