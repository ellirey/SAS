...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    // },
    addGuest: function () {
      var _addGuest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
var render = function render() {
  ...
  }, [_vm._m(2), _vm._v(" "), _c("tbody", _vm._l(_vm.guest_form.data, function (guest, index) {
    return _c("tr", {
      key: index,
      staticStyle: {
        "text-align": "center"
      }
    }, [_c("td", [_vm._v(_vm._s(guest.guest_code))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(guest.fname || _vm.upText) + " " + _vm._s(guest.mname || _vm.upText) + ". " + _vm._s(guest.lname || _vm.upText))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(guest.ocupation))]), _vm._v(" "), _c("td", [_c("button", {
